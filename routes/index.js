...
router.get('/', function (req, res) {
  res.render('index', { title: 'Apartment App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Apartment App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Apartment App Login', user: req.user });
});
